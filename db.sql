...
--
-- Host: localhost    Database: kredyty
-- ------------------------------------------------------
...
CREATE TABLE `application` (
  ...
  CONSTRAINT `application_ibfk_1` FOREIGN KEY (`application_offer`) REFERENCES `offer` (`offer_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `application` VALUES (1,'test','test','92050307190','test@test.pl','123',2),(2,'test','test','92050307190','test@test.pl','123',2);
...
INSERT INTO `offer` VALUES (1,'Test 1','test-1'),(2,'Test 2','test-2');
...
-- Dump completed on 2015-12-12 16:35:57
